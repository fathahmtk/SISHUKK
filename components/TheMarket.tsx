      ...
      <div className="container mx-auto px-6">
        <div className="mb-16">
          ...
          <h2 className="text-white font-serif text-4xl md:text-6xl mb-6">
            Guruvayur Is a Demand Market, <br/>
            <span className="italic text-slate-500">Not a Tourism Bet.</span>
          </h2>
          <p className="text-slate-400 max-w-3xl text-lg mb-8">
            Guruvayur operates on ritual economics, not tourism cycles. Unlike city hotels or leisure resorts, this market does not depend on weekends, holidays, or corporate travel.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {[
            { icon: Users, title: "Daily Rituals", desc: "Constant religious footfall" },
            { icon: Calendar, title: "Continuous Weddings", desc: "No 'off-season' for ceremonies" },
            { icon: MapPin, title: "Family Stays", desc: "Multi-day, multi-room bookings" },
            { icon: BarChart, title: "Emotion-Driven", desc: "Price inelastic spending" },
          ].map((item, i) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white/[0.02] border border-white/5 p-8 md:p-12">
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-slate-300 text-sm border-l border-gold-500/30 pl-4">Low seasonality risk profile</li>
              <li className="text-slate-300 text-sm border-l border-gold-500/30 pl-4">High willingness to pay for premium proximity</li>
              <li className="text-slate-300 text-sm border-l border-gold-500/30 pl-4">Predictable booking patterns</li>
            </ul>
          </div>
          <div className="flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-white/10 lg:pl-12 pt-8 lg:pt-0">
            <p className="text-2xl font-serif text-white italic">
              "Demand risk is structurally low."
            </p>
          </div>
        </div>
      </div>
