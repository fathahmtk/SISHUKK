        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 group">
                <div className="bg-white/5 p-4 h-fit rounded border border-white/10 group-hover:border-gold-500/50 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-6">
               <div className="flex gap-4 group">
                <div className="bg-white/5 p-4 h-fit rounded border border-white/10 group-hover:border-gold-500/50 transition-colors">
                  <Server className="text-slate-200" size={24} />
                </div>
                <div>
              ...
              <div className="flex gap-4 group">
                <div className="bg-white/5 p-4 h-fit rounded border border-white/10 group-hover:border-gold-500/50 transition-colors">
                  <Wifi className="text-slate-200" size={24} />
                </div>
                <div>
               ...
               <div className="flex gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm mt-1">Integrated logistics software for seamless weddings and high-end surveillance.</p>
                </div>
              </div>
            </div>
          </div>
