...
import { X, FileDown, ShieldCheck, Loader2, BookOpen } from 'lucide-react';
...
const GlobalLoader = () => (
  <div className="fixed inset-0 z-[1000] bg-[#050505] flex flex-col items-center justify-center text-white">
    ...
    <div className="flex flex-col items-center gap-3">
      <span className="text-gold-500 text-[10px] font-black uppercase tracking-[0.8em] animate-pulse">Synchronizing Monograph</span>
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="bg-[#FDFBF7] font-sans selection:bg-gold-500/20 selection:text-gold-900 min-h-screen flex flex-col">
      ...
      <Navbar onInvestorClick={scrollToArchives} />
      <DossierNav />
      
      <main className="animate-fade-in flex-1">
        <Suspense fallback={<GlobalLoader />}>
          <Routes>
            <Route path="/" element={<Home onInvestorClick={scrollToArchives} onProfileClick={() => setIsProfileOpen(true)} />} />
        ...
        {location.pathname === '/' && (
          <section className="bg-[#050505] py-40 md:py-64 border-y border-white/[0.05] text-center px-6 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
              ...
              <h2 className="text-white font-serif text-6xl md:text-[9rem] mb-16 leading-[0.8] tracking-tighter italic">The Project <br/><span className="gold-gradient-text not-italic font-black">Archives.</span></h2>
              ...
              <p className="mt-20 text-slate-600 text-[9px] uppercase tracking-[0.4em] font-black max-w-lg mx-auto leading-relaxed italic">
                *Verified structural specifications and lifestyle benchmarks current as of January 2025.
              </p>
            </div>
          </section>
        )}
      ...
      <footer className="py-20 text-center border-t border-slate-100 bg-white">
        <div className="container mx-auto px-6">
          <p className="text-[10px] uppercase tracking-[0.6em] text-slate-400 font-black mb-6 italic">
            Official Project Document | Sirshukk Grand Towers 2025
          </p>
          <div className="flex justify-center items-center gap-8 text-[9px] text-slate-900 font-black uppercase tracking-widest">
            ...
            <span>Landmark Series 2027</span>
          </div>
        </div>
      </footer>
    </div>
